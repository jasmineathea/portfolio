    ...
    <div className="min-h-screen w-screen flex flex-col">
      ...
      <div className="bg-slate-700 w-full py-2 pb-8 border-b border-black">
        <div className="flex flex-col items-center w-11/12 max-w-4xl mx-auto font-pixel text-center">
          {/* Navn */}
          <h1 className="text-3xl font-bold text-white mb-4">NASA-turen 2023</h1>

          {/* Beskrivelse */}
          <p className="mb-4 text-gray-50">
            Jenter og Teknologi har en årlig konkurranse der vinnerne blir sendt på tur til NASA (eventuelt ESA). I 2023 søkte jeg - og vant! I Houston fikk jeg møte astronauter og astronomer, de som trener opp astronautene, og andre som jobber med spacetech. Her er en oversikt over noe av det jeg fikk se og oppleve. Enjoy! 🚀
          </p>
        </div>
      </div>
      ...
      <div className="flex-grow flex flex-col items-center w-full bg-indigo-200 py-8 pt-12">
        <Window title="På programmet 🪐" className="w-[90%] lg:w-[75%]">
          <div className="text-black space-y-4">
            ...
            <div>
              <div>
                <h3 className="font-bold text-lg font-pixel">Dag 4:</h3>
              </div>
              <ul className="list-disc pl-6 text-sm text-gray-800 mt-2">
                <li>bla bla bla</li>
                <li>bla bla</li>
            ...
            <div>
              <div>
                <h3 className="font-bold text-lg font-pixel">Dag 5:</h3>
              </div>
              <ul className="list-disc pl-6 text-sm text-gray-800 mt-2">
                <li>bla bla bla</li>
                <li>bla bla</li>
            ...
            <div>
              <div>
                <h3 className="font-bold text-lg font-pixel">Dag 6:</h3>
              </div>
              <ul className="list-disc pl-6 text-sm text-gray-800 mt-2">
                <li>bla bla bla</li>
                <li>bla bla</li>
            ...
            <div>
              <div>
                <h3 className="font-bold text-lg font-pixel">Dag 7:</h3>
              </div>
              <ul className="list-disc pl-6 text-sm text-gray-800 mt-2">
                <li>bla bla bla</li>
                <li>bla bla</li>
